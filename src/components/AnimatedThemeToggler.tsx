...
import { motion } from "framer-motion"; // Adjusted to fit your existing framework package
...
export function AnimatedThemeToggler({
    ...
    useEffect(() => {
        // Check if system initialized dark mode class
    ...
    return (
        <>
            <style>{`
        .att-btn{--at-ink:rgba(0,0,0,0.65)}
