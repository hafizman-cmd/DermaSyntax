  ...
  return (
    <header className="flex h-16 w-full items-center justify-between border-b-2 border-black bg-white dark:border-white dark:bg-zinc-950/60 backdrop-blur-md px-8 select-none relative z-50 transition-colors duration-500">
      ...
      <div className="flex items-center gap-4">
        <h1 className="text-sm font-black uppercase tracking-[0.2em] text-black dark:text-zinc-50 transition-colors duration-300">
      ...
      <div className="flex items-center gap-6">
        ...
        {/* FIXED: Standardized dark background and dark shadow token definitions to align visual weights */}
        ...
        {/* FIXED: Standardized dark shadow token definitions to align visual weights */}
        <button
          onClick={clearAll}
